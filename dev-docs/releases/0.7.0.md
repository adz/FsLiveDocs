...
- Verify all snapshot examples from one project in a shared FSI session instead of retaining a compiler session per example. Large captures now keep compiler memory bounded per project and finish explicit verification substantially faster.
